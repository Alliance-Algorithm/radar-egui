...
impl MinimapWidget {
    ...
    pub fn show_with_state(
        ...
        let robots: &[(&str, [i16; 2], egui::Color32)] = &[
            ("英雄", [info.enemy_hero.x, info.enemy_hero.y], theme::HERO_COLOR),
            ("工程", [info.enemy_engineer.x, info.enemy_engineer.y], theme::ENGINEER_COLOR),
            ("步兵1", [info.enemy_infantry_3.x, info.enemy_infantry_3.y], theme::INFANTRY1_COLOR),
            ("步兵2", [info.enemy_infantry_4.x, info.enemy_infantry_4.y], theme::INFANTRY2_COLOR),
            ("无人机", [info.enemy_aerial.x, info.enemy_aerial.y], theme::DRONE_COLOR),
            ("哨兵", [info.enemy_sentry.x, info.enemy_sentry.y], theme::SENTINEL_COLOR),
            ("友英雄", [info.ally_hero.x, info.ally_hero.y], theme::HERO_COLOR.gamma_multiply(0.5)),
            ("友工程", [info.ally_engineer.x, info.ally_engineer.y], theme::ENGINEER_COLOR.gamma_multiply(0.5)),
            ("友步1", [info.ally_infantry_3.x, info.ally_infantry_3.y], theme::INFANTRY1_COLOR.gamma_multiply(0.5)),
            ("友步2", [info.ally_infantry_4.x, info.ally_infantry_4.y], theme::INFANTRY2_COLOR.gamma_multiply(0.5)),
            ("友无人机", [info.ally_aerial.x, info.ally_aerial.y], theme::DRONE_COLOR.gamma_multiply(0.5)),
            ("友哨兵", [info.ally_sentry.x, info.ally_sentry.y], theme::SENTINEL_COLOR.gamma_multiply(0.5)),
        ];
